...
echo "  1. Rode a aplicação: ${BLUE}make run-app${NC} ou ${BLUE}./mvnw spring-boot:run -Dspring-boot.run.profiles=local${NC}"
echo "  2. Acesse o Swagger: ${BLUE}http://localhost:8081/swagger-ui.html${NC}"
echo ""
echo "Interfaces Web Disponíveis:"
echo "  - LocalStack Resource Browser: ${BLUE}https://app.localstack.cloud/inst/default/resources${NC}"
echo "  - LocalStack Health: ${BLUE}http://localhost:4566/_localstack/health${NC}"
echo "  - Swagger UI: ${BLUE}http://localhost:8081/swagger-ui.html${NC} (após rodar a app)"
echo ""
echo "Comandos úteis:"
echo "  - Ver logs: ${BLUE}docker-compose logs -f${NC}"
echo "  - Parar tudo: ${BLUE}docker-compose down${NC}"
echo "  - Listar buckets: ${BLUE}aws --endpoint-url=http://localhost:4566 s3 ls${NC}"
echo ""
